...
This document describes how to copy and customise the USAID (bootstrapbase) theme so that
...
From your Moodle theme directory right click on usaid and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of usaid.
...
underscores. For the purpose of this tutorial we will call the theme 'usaidtheme'.

On opening 'usaidtheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case usaid. So using the above list as
a guide, search through and change all the instances of the theme name
'usaid' to 'usaidtheme'. This includes the filename of the lang/en/theme_usaid.php.
You need to change this to 'theme_usaidtheme.php'.
...
and then click on (USAIDtheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the USAID theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > USAID

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/USAID_theme
