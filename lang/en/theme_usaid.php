...
/**
 * Strings for component 'theme_usaid', language 'en'
 *
 * @package   theme_usaid
...
<div class="well">
<h2>USAID</h2>
<p><img class=img-polaroid src="usaid/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>USAID is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="usaid/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'USAID';
